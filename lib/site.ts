...
export const products: Product[] = [
  ...
  },
  {
    tag: "Contracts",
    price: "$59",
    slug: "contract-decoder",
    name: "The Contract Decoder",
    copy: "Your legal department, clause by clause. Mark what’s fine, what needs changing and what’s a deal breaker — then it writes the counter-offer email for you.",
    state: "Coming soon",
    img: "/img/contract-decoder.jpg",
  },
  {
    tag: "Money",
    price: "$29",
    slug: "invoice-generator",
    name: "The Invoice Generator",
    copy: "Your finance department in two tabs. Build the invoice once, then chase it — including the email that gets answered without burning the relationship.",
    state: "Coming soon",
    img: "/img/invoice-generator.jpg",
  },
  {
    tag: "Pitching",
    price: "$35",
